...
16. Unsupported syntax fails explicitly rather than silently reducing analysis
    coverage.
17. RuntimeManifest and its bounded reference consumer stay source-free and do
    not absorb framework, authentication, persistence, or deployment ownership.
    IDE and cloud surfaces remain deferred until a measured use case justifies
